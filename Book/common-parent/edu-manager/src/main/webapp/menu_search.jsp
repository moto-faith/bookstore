...
//                var li = '<li><a href="route_list.html?cid='+data[i].cid+'">'+data[i].cname+'</a></li>';
                var li = '<a href="${pageContext.request.contextPath}/showProductByPage.do?category='+data[i].cname+'">'+data[i].cname+'</a>';
                lis +=li;
            }
            lis+='<a href="${pageContext.request.contextPath}/showProductByPage.do" style="color:#FFFF00">全部商品目录</a>';
            $("#divmenu").html(lis);
...
<div id="divsearch">
	<form action="${pageContext.request.contextPath}/findProductBySearch.do"
		method="post">
