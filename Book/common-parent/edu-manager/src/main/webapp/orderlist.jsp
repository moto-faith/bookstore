				...
				<td width="25%"><table width="100%" border="0" cellspacing="0"
						...
						<tr>
							<td class="listtd"><img src="images/miniicon.gif" width="9"
								height="6" />&nbsp;&nbsp;&nbsp;&nbsp; <a
								href="${pageContext.request.contextPath}/findUserById.do?id=${user.id}">用户信息修改</a>
							</td>
						</tr>

						<tr>
							<td class="listtd"><img src="images/miniicon.gif" width="9"
								height="6" />&nbsp;&nbsp;&nbsp;&nbsp; <a href="${pageContext.request.contextPath}/findOrderById.do">订单查询</a>
							</td>
						</tr>
						<tr>
							<td class="listtd"><img src="images/miniicon.gif" width="9"
								height="6" />&nbsp;&nbsp;&nbsp;&nbsp; <a href="${pageContext.request.contextPath}/logout.do">用戶退出</a></td>
						</tr>
							...
							<td style="padding:20px"><p>欢迎${user.username}光临商城！</p>
								...
								<table width="100%" border="0" cellspacing="0" class="tableopen">
									...
									<tr>
										...
										<td class="tableopentd03"><a href="${pageContext.request.contextPath}/findOrderByOrderId.do?orderId=${order.id}">查看</a>&nbsp;&nbsp;
											<a href="${pageContext.request.contextPath}/delOrderByOrderId.do?orderId=${order.id}"  ${order.paystate == 1 ? 'hidden':'' }>刪除</a>
										</td>
									</tr>
									</c:forEach>
